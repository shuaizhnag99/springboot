...
<!--                     <input name="balance" class="balance-input" type="text"  readonly /> -->
                ...
                <div class="lend-mid-con">
                  <table>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="holdingBank">
                          <select name="receiveAcc" class="receiveAcc select-lend">
                          </select>
                        </div>
                      </td>
                    </tr>
                    <%-- <tr>
                      <td>日利率：</td>
                      <td class="interRate">日利率0.023%（月息7厘）</td>
                    </tr>
                    <tr>
                      <td>借款到期日：</td>
                      <td class="last-b-date">
                        <select name="lastRepayDate" class="lastRepayDate select-lend">
                    ...
                    <!-- <tr>
                      <td>服务费率：</td>
                      <td class="serviceRate">1.20%（放款后一次收取）</td>
                    </tr>
                    <tr>
                      <td>费用预估：</td>
                      <td class="forecast">利息0.00 + 服务费0.00 = 0.00</td>
                    </tr> -->
                   <tr>
                       <td>还款方式：</td>
                       <td class="repayType">
