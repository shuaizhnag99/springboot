...
@Controller
@RequestMapping("")///interface/paymentRefund  批销支付改造，原来的接口不再使用
public class PayAndRefundController {
	private static Logger log = LoggerFactory.getLogger(PayAndRefundController.class);
	@Autowired
...
//			log.info("validatecode=="+map.get("validatecode"));
			...
			JSONObject  jasonObject = JSONObject.fromObject(re);
			 ...
			 if("0000".equals(Convert.toStr(returnMap.get("code")))){
				 ...
				 returnMap.put("merchantId", "100000002");
				 
				 Map<String,String> signMap = MapSign.sign(returnMap, UhjSecurityProperty.get("100000002"));
...
//			saveSmsRedis(js, phone);//cafa暂时不上
	...
	public static void main(String args[]) throws UnsupportedEncodingException{
		...
		String productDetail="W3siaXRlbXMiOlt7ImlkIjoiODAwMDUzMjkyMDEiLCJuYW1lIjoi5Y+M5bGP5pS26ZO25py677yI5ZCr54Ot5pWP5omT5Y2w5py677yJ77yI5pSv5oyB5o6M5p+c6LS3MjTmnIjliIbmnJ/ov5jmrL7vvIkiLCJudW0iOjEsInByaWNlIjoxOTk5fV0sIm9yZGVyQW1vdW50IjoxOTk5LCJvcmRlck5vIjoiODE4MTIxNzIyMjM1NTQ4MCJ9XQ==";
		productDetail= new String (Base64.decodeBase64(productDetail.getBytes()));
		com.alibaba.fastjson.JSONArray projson=com.alibaba.fastjson.JSONArray.parseArray(productDetail);
		System.out.println(projson);
		for(Object pro:projson){
			  JSONObject prj= JSONObject.fromObject(pro);
			  System.out.println(Convert.toBigDecimal(prj.get("orderAmount"),new BigDecimal(0)));
			  
		  }
//		JSONArray js=JSONArray.fromObject(productDetail);
//		List<Map<String,Object>> list=new ArrayList<Map<String,Object>>();
//		Map<String,Object> map1=new HashMap<String, Object>();
//		map1.put("orderAmount", "5200");
//		map1.put("orderNo", "2016051029324303");
//		list.add(map1);
//		Map<String,Object> map2=new HashMap<String, Object>();
//		map2.put("orderAmount", "2633");
//		map2.put("orderNo", "2016051029324304");
//		list.add(map2);
		try {
//			String str=SpecialBASE64.decode("W3siaXRlbXMiOlt7ImlkIjoiODAwMDAwMDc1MjAxIiwibmFtZSI6Iumdnui9rOWfuuWboDIiLCJudW0iOjEsInByaWNlIjowLjAxfV0sIm9yZGVyQW1vdW50IjowLjAxLCJvcmRlck5vIjoiODE4MTEwODEwMDk3MzczOSJ9XQ==");
//			System.out.println(str);
//			String url="http://uhj-zgdPaymentService.http.beta.uledns.com/zgdPaymentService/interface/paymentRefund/queryBalance.do";
//			Map<String,String> parmMap=new HashMap<String, String>();
//			parmMap.put("message", "{%22channel%22:%22PC%22,%22sign%22:%22e889801f5ed5fe12954c4d89cd6622a0%22,%22userOnlyId%22:%2210000000391%22}");
//			String re=com.ule.uhj.util.http.HttpClientUtil.sendPost(url, parmMap);
//			String re="{\"sign\":\"M0JBNUMwMDZGRkMzMUU0M0JDQTQyMzk3N0Y1QkM4QTU%3D\",\"productDetail\":\"\",\"payableAmount\":\"0.01\",\"userOnlyId\":\"10000028690\",\"merchantId\":\"88888888\"}"; 
//			String json=JsonUtil.getJsonStringFromObject(re);
//			log.info("orderPayInfo json "+json);
//			 
//			Map<String,Object> map=JsonUtil.getMapFromJsonString(json);
//			
...
//		 
//			Object  message="{\"sign\":\"MDZCQkI3NjY2QUVGRjdCRTIwQkM4ODdEOEQwMjE4RDU%3D\",\"returnUrl\":\"\",\"terminalCreateIp\":\"\",\"productDetail\":\"W3siaXRlbXMiOlt7ImlkIjoiODAwMDAwMDY4ODAxIiwibmFtZSI6Iumdnui9rOWfuuWboOWkp+ixhueOieexs+iKseeUn+ayuSIsIm51bSI6MjgwMCwicHJpY2UiOjQ0LjQ0fV0sIm9yZGVyQW1vdW50IjoxMjQ0MzIsIm9yZGVyTm8iOiI4MTgxMjExMTAwOTc1NjYxIn1d\",\"payableAmount\":\"100000.0\",\"validatecode\":\"185657\",\"userOnlyId\":\"10000032560\",\"merchantId\":\"100000002\",\"notifyUrl\":\"\",\"reqNo\":\"21812111336110198066\",\"channel\":\"APP\"}";
//			log.info("orderPayInfo 确认订单时的信息 message ==="+message);
//			String json=JsonUtil.getJsonStringFromObject(message);
//			log.info("orderPayInfo json "+json);
//			if(StringUtils.isBlank(json)){
...
//			if(StringUtils.isNotBlank(Convert.toStr(map.get("productDetail")))){
//				productDetail =SpecialBASE64.decode(Convert.toStr(map.get("productDetail")));
//			}
//			
//			
//			log.info("orderPayInfo userOnlyId "+userOnlyId+"merchantId"+merchantId+"channel"+channel);
//			String[] str=getParamsFromRequest(map);
//			if(!piXiaoPayVerfiy(map,merchantId,str)){
//				log.info("orderPayInfo userOnlyId "+userOnlyId+" 验签失败了");
//			 
//				System.out.println("pro..."+productDetail);
//			}
			BigDecimal o=new BigDecimal(0);
			BigDecimal b=new BigDecimal("24.560");
			String [] a={"12.2","12.36"};
			for(String s:a){
				o=o.add(Convert.toBigDecimal(s));
//				b=b.add(Convert.toBigDecimal(s));
			}
			System.out.println("o..."+o);
			System.out.println("b..."+b);
			System.out.println(b.compareTo(o));
		} catch (Exception e) {
