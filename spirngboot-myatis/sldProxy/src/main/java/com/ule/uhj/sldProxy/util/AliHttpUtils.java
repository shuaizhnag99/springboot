...
public class AliHttpUtils {
	...
	private static void sslClient(HttpClient httpClient) {
        try {
        	String TLSStr = "TLS";
            SSLContext ctx = SSLContext.getInstance(TLSStr);
...
//	    String path = "/bank";
//	    String method = "GET";
//	    String appcode = "efa7f53a39a947f39cc79d97c7507318";
//	    Map<String, String> headers = new HashMap<String, String>();
//	    headers.put("Authorization", "APPCODE " + appcode);
//	    Map<String, String> querys = new HashMap<String, String>();
//	    querys.put("Mobile", "15381398144");
//	    querys.put("bankcard", "6210983320012236909");
//	    querys.put("cardNo", "330222196011208660");
//	    querys.put("realName", "姚文芬");
//
//
//	    try {
