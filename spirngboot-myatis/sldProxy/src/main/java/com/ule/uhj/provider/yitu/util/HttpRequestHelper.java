...
import com.ule.uhj.provider.yitu.util.EncryptionHelper.MD5Helper.Md5EncodingException;
import com.ule.uhj.provider.yitu.util.EncryptionHelper.RSAHelper.PublicKeyException;
...
public class HttpRequestHelper {
	protected static Log log = LogFactory.getLog(HttpRequestHelper.class);
